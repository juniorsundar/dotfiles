	...
	config = function()
		...
		local mappings = {
			...
			L = {
				...
				r = { "<cmd>Trouble lsp_references focus=true<cr>", "References" },
				...
				t = { "<cmd>Trouble lsp_type_definitions focus=true<cr>", "Type Definition" },
				...
				D = {
					...
					s = { "<cmd>Trouble lsp_document_symbols win.position=right<cr>", "Document Symbols" },
